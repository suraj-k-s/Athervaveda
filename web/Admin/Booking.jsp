...
<html lang="en" >
    ...
    <%
        if (request.getParameter("id") != null) {
            ...
            String upQry = "update tbl_packagebooking set packagebooking_status='" + request.getParameter("sts") + "' where packagebooking_id='" + request.getParameter("id") + "'";
    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_packagebooking b inner join tbl_user u on u.user_id=b.user_id";
                ...
                <tr>
                    <td><%=i%></td>
                    <td><%=rs.getString("packagebooking_date")%></td>
                    <td><%=rs.getString("user_email")%></td>
                    <td align="center">
                        <%

                            if (rs.getString("packagebooking_status").equals("0")) {
                        %>
                        <a href="Booking.jsp?id=<%=rs.getString("packagebooking_id")%>&sts=1">Accept</a>
                        <a href="Booking.jsp?id=<%=rs.getString("packagebooking_id")%>&sts=2">Reject</a>
                        <%
                        } else if (rs.getString("packagebooking_status").equals("2")) {
                        %>
                        Rejected | <a href="Booking.jsp?id=<%=rs.getString("packagebooking_id")%>&sts=1">Accept</a>
                        <%
                        } else if (rs.getString("packagebooking_status").equals("1")) {
                        %>
                        Accepted | <a href="Booking.jsp?id=<%=rs.getString("packagebooking_id")%>&sts=2">Reject</a>
                        <%
                            }
...
//                                                    }
                                        ...
                                        // Right side: curpackagebooking page and total pages
