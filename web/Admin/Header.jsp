...
<nav class="sidebar">
    ...
    <ul id="sidebar_menu">
        ...
        <li class="mm-active">
         ...
         <li>
             <a  href="BookingList.jsp"  aria-expanded="false">
                <img src="../Assets/Template/admin/img/menu-icon/2.svg" alt="">
                <span>Bookings</span>
            </a>
        </li>
        <li>
            <a  href="Doctor.jsp"  aria-expanded="false">
                <img src="../Assets/Template/admin/img/menu-icon/2.svg" alt="">
                <span>Doctor</span>
            </a>
        </li>
        <li>
            <a  href="Trainer.jsp"  aria-expanded="false">
                <img src="../Assets/Template/admin/img/menu-icon/2.svg" alt="">
                <span>Trainer</span>
            </a>
        </li>
        ...
        <li>
            <a  href="ServiceType.jsp"  aria-expanded="false">
                <img src="../Assets/Template/admin/img/menu-icon/2.svg" alt="">
                <span>Service Type</span>
            </a>
        </li>
        <li>
            <a  href="Package.jsp"  aria-expanded="false">
                <img src="../Assets/Template/admin/img/menu-icon/2.svg" alt="">
                <span>Package</span>
            </a>
        </li>
