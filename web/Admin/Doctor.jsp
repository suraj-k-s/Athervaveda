...
<html>
    ...
    <%
        if (request.getParameter("btn_save") != null) {
            String insQry = "insert into tbl_doctor(doctor_name,doctor_email,doctor_password)"
        ...
        if (request.getParameter("del") != null) {
            String delQry = "delete from tbl_doctor where doctor_id='" + request.getParameter("del") + "'";
                            ...
                            <div class="QA_section">
                                ...
                                <div class="QA_table mb_30">
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <%                                                int i = 0;
                                                String selQry = "select * from tbl_doctor";
                                            ...
                                            <tr>    
                                                ...
                                                <td align="center"><%=rs.getString("doctor_name")%></td>
                                                <td align="center"> 
                                                    <a href="Doctor.jsp?del=<%=rs.getString("doctor_id")%>" class="status_btn">Delete</a> 
                                                </td> 
                                            </tr>
                                            <%                      }
