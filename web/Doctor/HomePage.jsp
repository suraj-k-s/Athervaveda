                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                                    <div class="email">
                                        <a href="#"><img src="../Assets/Template/Main/images/mail_icon.png" /> Email : demo@gmail.com</a>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                                    <div class="logo">
                                        <a href="index.html"><img src="../Assets/Template/Main/images/logo.png" /></a>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                                    <div class="contact_nu">
                                        <a href="#"> <img src="../Assets/Template/Main/images/phone_icon.png" /> Contact : +71 71234567</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <nav class="navigation navbar-expand-md  navbar-dark ">
                                ...
                                <div class="collapse navbar-collapse" id="navbarsExample04">
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="Tips.jsp">Tips</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="../Guest/Login.jsp"> Sign Out</a>
                                        </li>
                                    </ul>
                                </div>
                            </nav>
                    ...
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="first-slide" src="../Assets/Template/Main/images/banner.jpg" alt="First slide">
                                <div class="container">
                            ...
                            <div class="carousel-item">
                                <img class="second-slide" src="../Assets/Template/Main/images/banner.jpg" alt="Second slide">
                                <div class="container">
                                    <div class="carousel-caption relative">
                                        <h1>Gather<br>
                                            <strong class="dark_brown">New Body Energy</strong></h1>
                            ...
                            <div class="carousel-item">
                                <img class="third-slide" src="../Assets/Template/Main/images/banner.jpg" alt="Third slide">
                                <div class="container">
                                    <div class="carousel-caption relative">
                                        <h1>Gather<br>
                                            <strong class="dark_brown">New Body Energy</strong></h1>
