...
//checking if request cotains multipart data
    ...
    String InsQry = "INSERT INTO tbl_package(servicetype_id, package_title, package_details,package_amount,package_photo)"
            + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + photo + "')";
