...
//checking if request cotains multipart data
        ...
        while (itr.hasNext())//checking if there is any value in the position like rs.next()
        {
            ...
            } else//when it is an image or multipart
            {
                ...
                if (field_name.equals("file_photo"))//write the name of image here it is img_product
                {
                    ...
                    photo = "TipsPhoto_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
    ...
    String InsQry = "INSERT INTO tbl_tips( tips_title, tips_details,tips_photo,doctor_id)"
            + "values('" + value[0] + "','" + value[1] + "','" + photo + "','"+session.getAttribute("did") +"')";
...
<script type="text/javascript">
    alert("Completed");
    setTimeout(function() {
        window.location.href = '../../Doctor/Tips.jsp'
