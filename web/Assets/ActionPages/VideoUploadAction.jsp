...
//checking if request cotains multipart data
        ...
        while (itr.hasNext())//checking if there is any value in the position like rs.next()
        {
            ...
            } else//when it is an image or multipart
            {
                ...
                if (field_name.equals("file_photo"))//write the name of image here it is img_product
                {
                    ...
                    photo = "Video_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
    ...
    String InsQry = "INSERT INTO tbl_video( video_title, video_details,servicetype_id,video_file,trainer_id)"
            + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + photo + "','"+session.getAttribute("tid") +"')";
...
<script type="text/javascript">
    alert("Completed");
    setTimeout(function() {
        window.location.href = '../../Trainer/Video.jsp'
