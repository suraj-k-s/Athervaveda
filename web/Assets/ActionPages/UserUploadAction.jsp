...
//checking if request cotains multipart data
    ...
    String InsQry = "INSERT INTO tbl_user( user_name, user_contact,user_email,user_address,user_gender,user_photo,place_id,user_password)"
            + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + value[4] + "','" + photo + "','" + value[6] + "','" + value[7] + "')";
