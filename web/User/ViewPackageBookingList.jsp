...
<html lang="en" >
    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_packagebooking rb inner join tbl_package u on u.package_id=rb.package_id where user_id='" + session.getAttribute("uid") + "'";
                ...
                <tr>
                    <td><%=i%></td>
                    <td><%=rs.getString("package_title")%></td>
...
//                                                    }
                                        ...
                                        // Right side: curpackage page and total pages
